        ...
        <div className="login-page-wrapper" dir="rtl">
            <div className="login-container">
                ...
                <div className="welcome-text">
                    <h1>ברוכים השבים! 👋</h1>
                    <p>היכנס לחשבון שלך כדי להמשיך</p>
                </div>
                ...
                <form className="login-form" onSubmit={handleEmailLogin}>
                    ...
                    <div className="form-options">
                        ...
                        <a href="#" onClick={(e) => e.preventDefault()} className="forgot-password">שכחת סיסמה?</a>
                    </div>
                ...
                <div className="social-login">
                    <button onClick={handleGoogleLogin} className="social-btn" type="button">
                        ...
                        <span>כניסה באמצעות Google</span>
                    </button>
                </div>

                {/* Register Link */}
                <div className="register-link">
                    אין לך חשבון? <Link to={ROUTES.REGISTER}>הירשם עכשיו</Link>
                </div>
            </div>
        </div>
    );
